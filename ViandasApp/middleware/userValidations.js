...
const validations = [
    ...
    body('city')    
                    .notEmpty().withMessage('Falta completar el campo Ciudad').bail()
                    .isLength({ min: 2 }).withMessage('La ciudad debe tener al menos 2 caracteres'),    
    
    body('country').
                    notEmpty().withMessage('Falta completar el campo País'),

    body('profile').
                    notEmpty().withMessage('Falta completar el perfil de usuario'),
    ...
    body('confirmPassword')
                    ...
                    .isLength({ min: 8 }).withMessage('La contraseña debe tener al menos 6 caracteres').bail()
                    .custom((value, { req }) => {
    ...
    body('avatar').custom((value, { req }) => {
                    ...
                    if (!file) {
                        throw new Error('Falta subir una imagen');
                    }else{
