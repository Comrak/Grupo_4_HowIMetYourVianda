# Archivo que contienen las retrospectivas del equipo para los anteriores Sprints  
...
### Jose Nardulli  
* Comenzar a hacer: Weekly y dayly meetings
* Hacer más: supervisar al equipo en los desarrollos y ayudarlos mas a completar sus tareas
* Continuar haciendo: Gestionar el repositorio de forma segura para evitar la perdida de datos
* Hacer menos: abarcar todas las tareas esperar a que el equipo elijan y quedarme con el resto
* Dejar de hacer: merge a un dia antes de la entrega
...
* Hacer más: Reuniones para resolver problemas en grupo.
* Continuar haciendo: Utilizando Trello y las metodologias de trabajo.
* Hacer menos: Perder tiempo en tratar de resolver problemas sin ayuda.
